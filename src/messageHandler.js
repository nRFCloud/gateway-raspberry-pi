...
function handleC2GMessage(message, bluetoothHandler) {
	...
	switch (op.type) {
		case 'scan': //Do a bluetooth scan
			bluetoothHandler.startScan(op.scanTimeout, op.scanMode, op.scanType, op.scanInterval, op.scanReporting, op.filter);
			break;
